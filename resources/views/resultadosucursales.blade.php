                    ...
                    @foreach($itemventas as $index => $item)
                        ...
                        @foreach($item as $index2 => $productos)
                            ...
                            <tr @php if(($n%2)!=0){  echo 'bgcolor="#eeeeee"';} @endphp>
                                <td align="left" class="tdline" colspan="2">{{ $productos['descrip'].'  '.$productos['color'] }}</td>
                                ...
                                <td align="right" class="tdline casilladollar" style="font-size:11px" >
                                    @php
                                        $resta =  $totallinepreciod-$totallinecostod;
                                    @endphp
                                ...
                                <td align="right" class="tdline casilladollar" style="font-size:11px" >
                                    @if(isset($totallinecostod) and isset($totallinepreciod))
                                        {{  number_format($totallinepreciod-$totallinecostod,2,',','.') }}
                                    @endif                                    </td>
                                ...
                                <td  align="center" class="tdline titulo" style="display: none"    >
                                    @if(isset($vectorsuc[$indexs]) and $vectorsuc[$indexs]>0)
                                        ...
                                        @php
                                            ...
                                            $totallinepreciod += $vectorsuccostod[$indexs];  $tttpreciod += $vectorsuccostod[$indexs];
                                            $totallinecostod  += $vectorsucpreciod[$indexs]; $tttcostod  += $vectorsucpreciod[$indexs];
                                        @endphp
                                    @endif                                </td>
                            @endforeach
