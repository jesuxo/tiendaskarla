            ...
            <div class="card">
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-lg-auto">
                            <select class="form-control" id="idmultiple" name="choices-multiple-default">
                                <option value="All" selected >Todos</option>
                        ...
                        <div class="col-lg-auto ms-auto">
                            <div class="hstack gap-2">
                                <a class="btn btn-light " href="/tarjetas"  >
                                        Ver Ubicaci&oacute;n Instrumentos de Pago
                                </a>
                            </div>
                        </div>
                        <div class="col-lg-auto ms-auto">
                        ...
                        <table class="table align-middle table-nowrap" id="customerTable">
                            <thead class="table-light">
                                <tr>
                                    ...
                                    <th class="sort" data-sort="multiple"> Multiple?</th>
                                    <th>Action</th>
                                </tr>
                            </thead>
                            <tbody class="list form-check-all">
                                <tr>
                                    ...
                                    <td class="multiple">
                                        <span  class="badge badge-soft-danger text-uppercase"></span>
                                    </td>
                                    <td>
            ...
            <div class="modal-content">
                ...
                <form class="tablelist-form" novalidate action="{{route('instpago.create')}}" autocomplete="off" method="post">
                    ...
                    <div class="modal-body p-4">
                        ...
                        <div  >
                            <label for="account-multiple-field" class="form-label"> Multiple?</label>
                            <select class="form-control" required id="account-multiple-field">
                                <option value="">Es uso de todas las sucursales?</option>
